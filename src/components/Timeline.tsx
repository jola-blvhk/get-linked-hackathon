...
export const TimeLine = () => {
  return (
    <>
      <section className="hidden md:block bg-[#150E28] padding_section border py-10">
        <div>
          <p className=" font-heading text-xl sm:text-2xl  md:text-3xl font-bold  mx-auto my-4 text-center">
            Timeline
          </p>
        ...
        <div className="timeline">
          <div className="timeline__component timeline__component--bg text-right">
            ...
            <p className="timeline__paragraph max-w-[500px] ml-auto text-sm md:text-md  leading-normal mr-0 pt-2">
